...
$outFile = $currentDir . DIRECTORY_SEPARATOR . "sets.php";
...
for ($raceNumber = 1; $raceNumber <= $totalRaces; $raceNumber++) {
    ...
    $setA = array_diff($toWin, $trio);
    $setB = array_diff($trio, $toWin);
    $setC = array_intersect($toWin, $trio);

    $racetext .= "\t\t'Set A' =>  [" . implode(", ", $setA) . "],\n";
    $racetext .= "\t\t'Set B' =>  [" . implode(", ", $setB) . "],\n";
    $racetext .= "\t\t'Set C' =>  [" . implode(", ", $setC) . "],\n";
